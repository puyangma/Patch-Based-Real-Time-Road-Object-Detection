...
parser.add_argument("--model_config_path", type=str, default="config/yolo-obj.cfg", help="path to model config file")
parser.add_argument("--data_config_path", type=str, default="config/obj.data", help="path to data config file")
parser.add_argument("--weights_path", type=str, default="checkpoints/17.weights", help="path to weights file")
